"""CLI — Interface de linha de comando do HORUS."""
...
from horus.utils import limpar_documento, get_logger
...
def _build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        prog="horus",
        description="🔍 HORUS — Análise de risco em dados públicos",
    )
...
def _exibir_resultado(resultado: "horus.risk_engine.ResultadoRisco") -> None:
