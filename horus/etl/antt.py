"""ETL da ANTT — Agência Nacional de Transportes Terrestres."""
...
class ANTTETL(BaseETL):
    """Extrator de dados da ANTT (dados abertos)."""
    ...
    DATASETS = {
        "transporte_rodoviario": "transporte-rodoviario-interestadual-e-internacional-de-passageiros",
        "concessoes_rodovias": "concessoes-de-rodovias",
        "ferrovias": "ferrovias-concedidas",
    }

    def _get_dataset(self, dataset_id: str) -> dict:
        rate_limiter.wait("antt", max_per_minute=15)
    ...
    def extract(self, **kwargs: Any) -> dict[str, dict]:
        ...
        for nome in datasets:
            ...
            try:
                ...
                self.logger.warning("Erro ANTT %s: %s", nome, e)
        return result
