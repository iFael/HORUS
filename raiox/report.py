...
from raiox.risk_engine import ResultadoRisco
...
class ReportGenerator:
    ...
    def generate(
        ...
        base_name = f"raiox_{resultado.cpf_cnpj}_{timestamp}"
    ...
    def _to_markdown(
        ...
        lines = [
            f"# 🔍 RaioX Público BR — Relatório de Análise",
            "",
...
<head>
    ...
    <title>RaioX Público BR — {resultado.nome}</title>
    <style>
